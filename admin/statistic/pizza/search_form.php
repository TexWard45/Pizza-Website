...
<div class="modal-dialog">
    <form class="search-form" onsubmit="return false;">
        ...
        <div class="modal-body">
            <div class="fw-bold"> Từ ngày: </div>
            <input class="form-control startdate" type="text" name="startdate" placeholder="yyyy-mm-dd">
            <div class="fw-bold"> Đến ngày: </div>
            <input class="form-control enddate" type="text" name="enddate" placeholder="yyyy-mm-dd">
        </div>
...
<script> 
    $(".search-form").submit(function() {
        $.ajax({
            url: "/admin/statistic/category/index.php", 
            method: "POST",
