...
if (isset($_POST['display'])) {
    $categorys = Category::getBySearch($_POST['display']);
}else {
...
<div class="p-3">
    <div class="d-flex justify-content-between">
        <div class="title">
            <span class="h3"> Quản lý danh mục bánh pizza </span>
        </div>
    ...
    <table class="table">
        ...
        ?>
            <tr>
                <td>
                    <input class="form-check-input checkbox" type="checkbox" data-id="<?=$category->getId()?>">
                </td>
...
<script>
    $(".item").click(function() {
        ...
        let arr = getSelects();
        $.ajax({
            url: "/admin/category/" + operation + "_form.php", 
            method: "POST",
            data: {id_array: arr},
